...
from src.generate.generate_client_data import generate_client_pii_records, generate_client_salary, create_client_record
...
class TestMainLogic:
    ...
    def test_main_function(self, mock_json_dump, mock_file, mock_parse_args):
        ...
        from src.generate.generate_client_data import main
