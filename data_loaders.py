...
def load_state_data(data_dir: Path):
    ...
    with open(data_dir / "state_reference_data.json", "r") as f:
...
def load_department_data(data_dir: Path):
    ...
    with open(data_dir / "departments.json", "r") as f:
...
def load_names_and_conditions(data_dir: Path, dist_config):
    ...
    with open(data_dir / "name_suffixes.txt", "r") as f:
    ...
    with open(data_dir / "middle_initials.txt", "r") as f:
...
def load_streets(data_dir: Path):
    """Load street names."""
    with open(data_dir / "streets.txt", "r") as f:
